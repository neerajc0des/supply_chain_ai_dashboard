...
export function AnalysisForm({
    ...
    const set = <K extends keyof AnalysisPayload>(
        k: K,
        v: AnalysisPayload[K]
    ) => setForm((f) => ({ ...f, [k]: v }));
    ...
    const labelCls =
        "block mb-1 text-muted-foreground uppercase tracking-widest";
    ...
    const sevColor =
        form.disruption_severity >= 4
            ? "#f87171"
            : form.disruption_severity >= 3
              ? "#f59e0b"
              : "#34d399";
